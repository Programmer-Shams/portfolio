...
const Info = () => {
  return (
    <motion.div
      ...
      className="bg-white -mt-[150px] md:-mt-[120px] w-[570px] h-[780px] md:h-[280px] lg:h-[220px] ml-7 md:mx-[40px] md:w-[50rem] lg:w-[80rem] rounded-xl px-5 shadow-lg flex flex-col md:flex-row gap-4  justify-center md:items-center"
    >
