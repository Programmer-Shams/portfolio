...
const Info = () => {
  return (
    <div className="bg-white -mt-[180px] md:-mt-[130px] w-[570px] h-[570px] md:h-[250px] lg:h-[220px] ml-7 md:mx-[40px] md:w-[50rem] lg:w-[80rem] rounded-xl px-6 shadow-lg flex flex-col md:flex-row gap-6  justify-center">
